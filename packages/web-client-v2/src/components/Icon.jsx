...
export const ChalkSprite = () => (
  <svg width="0" height="0" aria-hidden="true" focusable="false" style={{ position: 'absolute' }}>
    <defs>
      ...
      <symbol id="ic-gear" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" filter="url(#chalk)"><circle cx="12" cy="12" r="6.4" /><circle cx="12" cy="12" r="2.8" /><path d="M12 4 v1.8 M12 18.2 v1.8 M4 12 h1.8 M18.2 12 h1.8 M6.7 6.7 l1.3 1.3 M16 16 l1.3 1.3 M17.3 6.7 l-1.3 1.3 M8 16 l-1.3 1.3" /></g></symbol>
